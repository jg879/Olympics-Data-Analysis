...
def regions_over_time(df,col):

    regions_over_time = df.drop_duplicates(['Year', col])['Year'].value_counts().reset_index().sort_values('Year')
    regions_over_time.rename(columns={'count': 'No. of countries'}, inplace=True)
    return regions_over_time
